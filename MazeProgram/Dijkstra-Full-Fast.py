...
pygame.display.set_caption("dijkstra full fast")
    ...
    # Solving Algorithm / Solving the Maze            
        ...
        if (not allNodesChecked):
            ...
            if (solving_current.x==startingX and solving_current.y==startingY):
                ...
                print("solved using dijkstra full fast")
                print("time:",time,"seconds")
                print("full count:",full_count)
                print("count:",count)
                f = open("dijsktra-full-fast-output-file.txt", "w")
                f.write(str(time) + "\n")
